...
Cryptocurrency was developed as an electronic cash system that could operate without the oversight of financial institutions \cite{bitcoin}. By removing the need for centralized governance a trustless form of payment was created, eliminating third-party interference and giving users true ownership over their funds. Cryptocurrency has proven itself as a successful alternative to fiat currency, with an increasing number of individuals opting to use it as a form of payment for products and services \cite{bitcoin-popularity}.
